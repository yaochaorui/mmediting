...
train_pipeline = [
    ...
    dict(type='LoadImageFromFile', key='fg',io_backend='memcached', save_original_img=True,server_list_cfg= "/mnt/lustre/share/memcached_client/server_list.conf",
client_cfg = "/mnt/lustre/share/memcached_client/client.conf"),
    dict(type='RandomLoadResizeBg', bg_dir=bg_dir),
    dict(type='CompositeFg', fg_dirs=fg_dirs, alpha_dirs=alpha_dirs),
    dict(type='CropAroundUnknown',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/mnt/lustre/yaochaorui/Code/mmediting/fba.json',
